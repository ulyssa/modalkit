...
fn default_keys<I: ApplicationInfo>() -> Vec<(MappedModes, &'static str, InputStep<I>)> {
    [
        ...
        ( IMAP, "<C-N>", complete!(CompletionStyle::List(MoveDir1D::Next, true), CompletionType::Auto, CompletionDisplay::List) ),
        ( IMAP, "<C-O>", fallthrough!(VimMode::Normal) ),
        ( IMAP, "<C-P>", complete!(CompletionStyle::List(MoveDir1D::Previous, true), CompletionType::Auto, CompletionDisplay::List) ),
        ...
        ( CMAP, "<Tab>", complete!(CompletionStyle::List(MoveDir1D::Next, false), CompletionType::Auto, CompletionDisplay::None) ),
        ( CMAP, "<S-Tab>", complete!(CompletionStyle::List(MoveDir1D::Previous, false), CompletionType::Auto, CompletionDisplay::None) ),
