...
lazy_static! {
    static ref DEFAULT_KEYS: [(MappedModes, &'static str, InputStep);  470] = [
        ...
        ( NMAP, "o", act!(Action::OpenLine(MoveDir1D::Next, Count::Contextual), VimMode::Insert) ),
        ( NMAP, "O", act!(Action::OpenLine(MoveDir1D::Previous, Count::Contextual), VimMode::Insert) ),
